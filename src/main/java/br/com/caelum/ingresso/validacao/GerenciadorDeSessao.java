...
public class GerenciadorDeSessao {
	...
	private boolean horarioIsConflitante(Sessao sessaoExistente, Sessao sessaoNova) {
		...
		boolean terminaAntes = sessaoNova.getHoraioTermino().atDate(hoje).isBefore(horarioSessaoExistente);
		boolean comecaDepois = sessaoExistente.getHoraioTermino().atDate(hoje).isBefore(horarioSessaoNova);
